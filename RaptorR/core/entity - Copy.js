...
Entity.prototype.update = function () {
    ...
    if (this.keyboard.isKeyDown(32)) {
        ...
        if (this.cooldown > 0) {
            ...
            bulletmanager.addBullet([this.position[0] + this.orientation[0] * 5, this.position[1] + this.orientation[1] * 5, this.position[2] + this.orientation[2] * 5], [this.orientation[8], this.orientation[9], this.orientation[10]], -10);
            bulletmanager.addBullet([this.position[0] + this.orientation[0] * -5, this.position[1] + this.orientation[1] * -5, this.position[2] + this.orientation[2] * -5], [this.orientation[8], this.orientation[9], this.orientation[10]], -10);
    ...
    var facing = vec3.fromValues(this.x, 0, this.y);

    vec3.normalize(facing, facing);

    var right = vec3.create();
    
    vec3.cross(right, facing, vec3.fromValues(0, 1, 0));
    ...
    */
    ...
    console.log(this.acceleration[0] + "  " + this.acceleration[1] + "  " + this.acceleration[2]);
