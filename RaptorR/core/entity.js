...
Entity.prototype.update = function () {
    ...
    else if (controllers[0].buttons[15] > 0) {
    ...
    else if (controllers[0].buttons[12] > 0) {
    ...
    if (controllers[0].axes.length > 0) {
        if (Math.abs(controllers[0].axes[2]) > .2) {
            this.x = controllers[0].axes[2];
        }
        if (Math.abs(controllers[0].axes[3]) > .2) {
            this.y = controllers[0].axes[3];
        }

        if (Math.abs(controllers[0].axes[0]) > .2) {
            this.acceleration[0] = -controllers[0].axes[0];
        }
        if (Math.abs(controllers[0].axes[1]) > .2) {
            this.acceleration[2] = controllers[0].axes[1];
        }
    ...
    if (controllers[0].buttons[7] > 0) {
        ...
        if (this.cooldown > 0) {
            ...
            bulletmanager.addBullet([this.position[0] + gunright[0] * 5, this.position[1] + gunright[1] * 5, this.position[2] + gunright[2] * 5], [guns[0], guns[1], guns[2]], 5);
            bulletmanager.addBullet([this.position[0] + gunright[0] * -5, this.position[1] + gunright[1] * -5, this.position[2] + gunright[2] * -5], [guns[0], guns[1], guns[2]], 5);
...
Entity.prototype.getData = function (data) {

    data = this.velocity[0];
